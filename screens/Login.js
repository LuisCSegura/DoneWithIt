...
const Login = ({ navigation }) => {
    ...
    const handleLogin =(credentials, setSubmitting)=>{
        handleMessage(null);
        const url='https://warm-waters-20510.herokuapp.com/user/signin';
    ...
    const handleGoogleSingin = () =>{
        ...
        const config={
        iosClientId: `745092887150-qvfdkfq55sgei3nokkb198npm8i59hig.apps.googleusercontent.com`,
        androidClientId:`745092887150-s6b13hoflvif0isa54te05alogh7mglk.apps.googleusercontent.com`,
                    ...
                    >
                        {({ handleChange, handleBlur, handleSubmit, values, isSubmitting }) => (
                            <StyledFormArea>
                                ...
                                {!googleSubmitting && 
                                <StyledButton google={true} onPress={handleGoogleSingin}>
